...
class Fader():
    ...
    def fade_in(self, surface):
        ...
        pygame.draw.rect(surface, self.colour, (0 -
                         self.fade_counter, 0, SCREEN_WIDTH // 2, SCREEN_HEIGHT))
        pygame.draw.rect(surface, self.colour, (SCREEN_WIDTH //
                         2 + self.fade_counter, 0, SCREEN_WIDTH, SCREEN_HEIGHT))
        pygame.draw.rect(surface, self.colour, (0, 0 -
                         self.fade_counter, SCREEN_WIDTH, SCREEN_HEIGHT // 2))
        pygame.draw.rect(surface, self.colour, (0, SCREEN_HEIGHT //
